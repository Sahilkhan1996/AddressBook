...
//            addressBook.setAddressBookName(addressBookName);
			...
			start: while (menuAgain) {
				...
				case 3:
					while (askToDeleteContact) {
						...
						System.out
								.println("Do you wish to delete another contact? (Enter Y to delete or any key as No)");
		...
		for (Map.Entry<String, AddressBook> pair : map.entrySet()) {
			System.out.println("Address Book Name is: " + pair.getKey() + " and its Contacts are :"
					+ pair.getValue().contactsArrayList);
		}
